...
<div class="flex h-full w-full flex-1 flex-col gap-6 p-4 sm:p-6 md:p-8">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
            ...
            <h1 class="text-xl sm:text-xl font-extrabold tracking-tight text-slate-900 dark:text-white">Reports &
                Analytics</h1>
            <p class="text-sm text-slate-600 dark:text-slate-400">Generate, analyze, and export sales, inventory, and
                cashier reports</p>
        </div>
        ...
        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4 items-end">
            ...
            <div>
                <div
                    ...
                    {{ Carbon::parse($startDate)->format('M d, Y') }} &rarr;
        ...
        <div class="space-y-6">
                    ...
                    <div class="flex items-center justify-between">
                        <div class="space-y-1">
                            ...
                            <p class="text-xl sm:text-xl font-extrabold text-slate-900 dark:text-white tracking-tight">
                                ₦{{ number_format($this->salesData['total_sales'], 2) }}</p>
                        </div>
                        <div
                    ...
                    <div class="flex items-center justify-between">
                        <div class="space-y-1">
                            <p class="text-xs font-semibold uppercase tracking-wider text-slate-500 dark:text-slate-400">
                                Total Quantity</p>
                            <p class="text-xl sm:text-xl font-extrabold text-slate-900 dark:text-white tracking-tight">
                                {{ number_format($this->salesData['total_quantity'], 2) }} <span
                    ...
                    <div class="flex items-center justify-between">
                        <div class="space-y-1">
                            <p class="text-xs font-semibold uppercase tracking-wider text-slate-500 dark:text-slate-400">
                                Transactions</p>
                            <p class="text-xl sm:text-xl font-extrabold text-slate-900 dark:text-white tracking-tight">
                                {{ $this->salesData['total_transactions'] }}</p>
                        </div>
                        <div
                    ...
                    <div class="flex items-center justify-between">
                        <div class="space-y-1">
                            <p class="text-xs font-semibold uppercase tracking-wider text-slate-500 dark:text-slate-400">
                                Avg. Transaction</p>
                            <p class="text-xl sm:text-xl font-extrabold text-slate-900 dark:text-white tracking-tight">
                                ₦{{ number_format($this->salesData['average_transaction'], 2) }}</p>
                        </div>
                        <div
            ...
            <div class="grid grid-cols-1 gap-6 lg:grid-cols-3">
                <div
                    ...
                    <h3 class="mb-4 text-base font-bold text-slate-900 dark:text-white tracking-tight">Transaction Status
                    </h3>
                    <div class="space-y-3 text-xs">
                        <div
                            class="flex justify-between items-center py-2 border-b border-slate-200/60 dark:border-slate-800/60">
                            <span class="text-slate-600 dark:text-slate-400">Completed:</span>
                            <span
                                class="font-bold text-emerald-600 dark:text-emerald-400">{{ $this->salesData['completed_transactions'] }}</span>
                        </div>
                        <div
                            class="flex justify-between items-center py-2 border-b border-slate-200/60 dark:border-slate-800/60">
                            <span class="text-slate-600 dark:text-slate-400">Cancelled:</span>
                            <span
                                class="font-bold text-red-600 dark:text-red-400">{{ $this->salesData['cancelled_transactions'] }}</span>
                        </div>
                        <div class="flex justify-between items-center py-2">
                            <span class="text-slate-600 dark:text-slate-400">Refunded:</span>
                            <span
                                class="font-bold text-amber-600 dark:text-amber-400">{{ $this->salesData['refunded_transactions'] }}</span>
                        </div>
                    </div>
                </div>
                ...
                <div
                    ...
                    <div class="space-y-3 text-xs">
                        <div
                            ...
                            <span
                                class="font-bold text-emerald-600 dark:text-emerald-400">{{ $this->salesData['cash_payments'] }}
                                (₦{{ number_format($this->salesData['cash_amount'], 2) }})</span>
                        </div>
                        <div
                            class="flex justify-between items-center py-2 border-b border-slate-200/60 dark:border-slate-800/60">
                            <span class="text-slate-600 dark:text-slate-400">Card:</span>
                            <span class="font-bold text-blue-600 dark:text-blue-400">{{ $this->salesData['card_payments'] }}
                                (₦{{ number_format($this->salesData['card_amount'], 2) }})</span>
                        </div>
                        <div class="flex justify-between items-center py-2">
                            <span class="text-slate-600 dark:text-slate-400">Transfer:</span>
                            <span
                                class="font-bold text-purple-600 dark:text-purple-400">{{ $this->salesData['transfer_payments'] }}
                                (₦{{ number_format($this->salesData['transfer_amount'], 2) }})</span>
                        </div>
                    </div>
                </div>
                ...
                <div
                    class="relative rounded-3xl border border-slate-200/80 dark:border-slate-800/80 bg-white/80 dark:bg-slate-900/70 p-6 backdrop-blur-xl shadow-xl overflow-hidden lg:col-span-1">
                    <h3 class="mb-4 text-base font-bold text-slate-900 dark:text-white tracking-tight">Daily Sales Trend
                    </h3>
                    <div class="h-52">
    ...
    @if($reportType === 'inventory')
        ...
        <div class="space-y-6">
                    ...
                    <div class="flex items-center justify-between">
                        <div class="space-y-1">
                            <p class="text-xs font-semibold uppercase tracking-wider text-slate-500 dark:text-slate-400">
                                Current Stock</p>
                            <p class="text-xl sm:text-xl font-extrabold text-slate-900 dark:text-white tracking-tight">
                                {{ number_format($this->inventoryData['current_stock'], 2) }} <span
                                    class="text-sm font-normal text-slate-500 dark:text-slate-400">kg</span></p>
                        </div>
                        <div
                            class="flex h-12 w-12 items-center justify-center rounded-2xl bg-gradient-to-br from-orange-500 to-amber-600 text-white shadow-lg shadow-orange-500/20 group-hover:scale-110 transition-transform">
                    ...
                    <div class="flex items-center justify-between">
                        <div class="space-y-1">
                            <p class="text-xs font-semibold uppercase tracking-wider text-slate-500 dark:text-slate-400">
                                Stock Value</p>
                            <p class="text-xl sm:text-xl font-extrabold text-slate-900 dark:text-white tracking-tight">
                                ₦{{ number_format($this->inventoryData['stock_value'], 2) }}</p>
                        </div>
                        <div
                            class="flex h-12 w-12 items-center justify-center rounded-2xl bg-gradient-to-br from-emerald-500 to-teal-600 text-white shadow-lg shadow-emerald-500/20 group-hover:scale-110 transition-transform">
                            <svg class="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="flex items-center justify-between">
                        <div class="space-y-1">
                            <p class="text-xs font-semibold uppercase tracking-wider text-slate-500 dark:text-slate-400">
                                Minimum Stock</p>
                            <p class="text-xl sm:text-xl font-extrabold text-slate-900 dark:text-white tracking-tight">
                                {{ number_format($this->inventoryData['minimum_stock'], 2) }} <span
                                    class="text-sm font-normal text-slate-500 dark:text-slate-400">kg</span></p>
                        </div>
                        <div
                            class="flex h-12 w-12 items-center justify-center rounded-2xl bg-gradient-to-br from-amber-500 to-yellow-600 text-white shadow-lg shadow-amber-500/20 group-hover:scale-110 transition-transform">
                    ...
                    <div class="flex items-center justify-between">
                        <div class="space-y-1">
                            <p class="text-xs font-semibold uppercase tracking-wider text-slate-500 dark:text-slate-400">
                                Status</p>
                            <p
                                class="text-xl sm:text-xl font-extrabold {{ $this->inventoryData['is_low_stock'] ? 'text-red-600 dark:text-red-400' : 'text-emerald-600 dark:text-emerald-400' }} tracking-tight">
                                {{ $this->inventoryData['is_low_stock'] ? 'Low Stock' : 'Good' }}
                            </p>
                        </div>
                        <div
                            class="flex h-12 w-12 items-center justify-center rounded-2xl {{ $this->inventoryData['is_low_stock'] ? 'bg-gradient-to-br from-red-500 to-rose-600 shadow-red-500/20' : 'bg-gradient-to-br from-emerald-500 to-teal-600 shadow-emerald-500/20' }} text-white shadow-lg group-hover:scale-110 transition-transform">
                            <svg class="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div
                class="relative rounded-3xl border border-slate-200/80 dark:border-slate-800/80 bg-white/80 dark:bg-slate-900/70 p-6 backdrop-blur-xl shadow-xl overflow-hidden">
                <h3 class="mb-3 text-lg font-bold text-slate-900 dark:text-white tracking-tight">Stock Level Capacity
                    Overview</h3>
                <div class="space-y-3">
                    <div class="flex justify-between text-xs font-semibold text-slate-600 dark:text-slate-400">
                        <span>Current: <strong
                                class="text-slate-900 dark:text-white">{{ number_format($this->inventoryData['current_stock'], 2) }}
                                kg</strong></span>
                        <span>Minimum Required: <strong
                                class="text-slate-900 dark:text-white">{{ number_format($this->inventoryData['minimum_stock'], 2) }}
                                kg</strong></span>
                    </div>
                    <div
                    ...
                    <div class="text-xs text-slate-500 dark:text-slate-400">
                        Operating at <strong
                            class="text-slate-800 dark:text-slate-200">{{ number_format($this->inventoryData['stock_percentage'], 1) }}%</strong>
        ...
        <div class="space-y-6">
            ...
            <div
                ...
                <div
                    ...
                    <h3 class="text-lg font-bold text-slate-900 dark:text-white tracking-tight">Cashier Performance Ledger
                    </h3>
                    <p class="text-xs text-slate-500 dark:text-slate-400">Sales revenue and quantity volume breakdown per
                        cashier</p>
                </div>
                ...
                <div class="p-0">
                                    ...
                                    @foreach($this->cashierPerformance as $cashier)
                                        <tr class="hover:bg-slate-50 dark:hover:bg-slate-800/40 transition-colors">
                                            <td class="whitespace-nowrap px-6 py-4">
                                                ...
                                                <div class="text-xs text-slate-500 dark:text-slate-400">{{ $cashier['email'] }}
                                                </div>
                                            </td>
                                            <td class="whitespace-nowrap px-6 py-4">
                                                <div class="font-extrabold text-emerald-600 dark:text-emerald-400">
                                                    ₦{{ number_format($cashier['total_sales'], 2) }}</div>
                                            </td>
                                            <td class="whitespace-nowrap px-6 py-4">
                                                <div class="font-semibold text-slate-900 dark:text-white">
                                                    {{ number_format($cashier['total_quantity'], 2) }} kg</div>
                                            </td>
                                            <td class="whitespace-nowrap px-6 py-4">
                                                <div class="font-medium text-slate-900 dark:text-white">
                                                    {{ $cashier['transactions'] }}</div>
                                            </td>
                                            <td class="whitespace-nowrap px-6 py-4">
                                                <div class="font-semibold text-slate-800 dark:text-slate-200">
                                                    ₦{{ number_format($cashier['average_transaction'], 2) }}</div>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
                    ...
                    @else
                        <div class="text-center py-12 px-4">
                            ...
                            <p class="text-xs text-slate-500 dark:text-slate-400 mt-1">Cashier performance metrics for this
                                period will appear here.</p>
                        </div>
                    @endif
                </div>
            </div>
