<div class="relative mb-6 w-full">
    ...
    <h1 class="text-xl sm:text-xl font-extrabold tracking-tight text-slate-900 dark:text-white">{{ __('Settings') }}
    </h1>
    <p class="text-sm text-slate-600 dark:text-slate-400 mb-6">
        {{ __('Manage your profile, security, company configuration, and system data') }}</p>
    <div class="h-px w-full bg-slate-200/80 dark:bg-slate-800/80"></div>
</div>